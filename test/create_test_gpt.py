...
def create_test_for_module(module_file_path):
    ...
    with open(module_file_path) as module:
        ...
        not fail and have not wrong math.
        5) Triple check if you are doing the math right.

        Remember to start your tests code the line bellow. Do not ommit it.
        First line: from src.tip_calculator import calculate_tip #DO NOT LEAVE THIS OUT
    ...
    with open(f"test_gpt_{module_file_name}", "w") as test_file:
